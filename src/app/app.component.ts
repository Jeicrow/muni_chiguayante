...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, CommonModule, MatIconModule, NavegacionComponent, HeaderComponent, MenusComponent, CarruselComponent, MenuNavegacionComponent, NoticiasComponent, ContactoComponent, FormLicenciadeconducirComponent],
